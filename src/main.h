...
/** The maximum block size of relationship rollback  */
static const unsigned int MAX_RELATIONSHIP_ROLLBACK_SIZE = 10000;
...
static const unsigned int DEFAULT_CHECKLEVEL = 0;
